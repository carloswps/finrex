...
export const ProfilePicContext = createContext<ProfilePicContextType | null>(null);
...
export const ProfilePicProvider = ({ children }: ProfilePicProviderProps) => {
  ...
  return <ProfilePicContext.Provider value={{ fileUrl, setFileUrl }}>{children}</ProfilePicContext.Provider>;
};
